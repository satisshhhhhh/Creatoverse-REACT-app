        ...
        <div className="section mb-100 mt-40 demos_wrap">
            <div className="container">
                <div className="section__head">
                    <h2 className="text-center title_demos mb-20"> Everything you need in
                        one place</h2>
                </div>
                <div className="demos mt-100">
                    <div className="row">
                        <div className="col-lg-3">
                            <Link to="marketplace" target="_blank" className="demo_item
                  is_lg
                  space-y-10">
                                ...
                                <div className="d-flex justify-content-between">
                                    <h5>Marketplace </h5>
                                    <div className="modes d-flex space-x-10">
                                        <img src="img/icons/light.svg" alt="light" />
                                        <img src="img/icons/dark.svg" alt="dark" />
                                    </div>
                                </div>
                            </Link>
                        </div>
                            ...
                            <div className="row">
                                {Pages1.map((val, i) => (
                                    ...
                                    <div className="col-lg-4 col-md-4 col-sm-6" key={i}>
                                        <Link to={val.link} target="_blank" className="demo_item
                          is_sm
                          space-y-10">
                                            <div className="img_wrap">
                ...
                <div className="demos mt-100">
                    <div className="row">
                        ...
                        <div className="col-lg-3">
                            <Link to="forum" target="_blank" className="demo_item
                  is_lg
                  space-y-10">
                                <div className="img_wrap">
