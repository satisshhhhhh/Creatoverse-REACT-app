            ...
            <div className="section my-100">
                <div className="container">
                    <div className="row">
                            ...
                            <div className="box_buy_wrapper relative mb-20">
                                ...
                                <div className="box_buy_wrapper2">
                                  ...
                                  flex-column space-y-10">
                                                    ...
                                                    <h1>$29</h1>
                                                    <Link to="https://themeforest.net/item/raroin-nft-marketplace/33730631" className="btn btn-primary btn-lg
                                      btn_buy">
                                                        Purchase now </Link>
                                                </div>
                                            </div>
                        ...
                        <div className="col-lg-4">
                            <div className="box box_buy border-0 hire_box text-center
              space-y-20">
