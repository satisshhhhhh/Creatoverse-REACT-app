  ...
  return (
    <div>
                  ...
                  <div className="card__item two">
                    <div className="card_body space-y-10">
                      ...
                      <div className="card_footer justify-content-between">
                        <Link to="profile" className="creators
                                                space-x-10">
                        ...
                        <div className="card_footer d-block space-y-10">
                          <Link to="profile" className="creators space-x-10">
                            <div className="avatars">
                              <img src={`img/avatars/avatar_${val.avatar_img}.png`} alt="Avatar" className="avatar avatar-sm" />
                            </div>
                            <p className="avatars_name txt_sm">
                              @{val.avatar_name}... </p>
                          </Link>
      ...
      _bold"
                            ...
                            <span className="color_green txt_xs
                                                        text-right">{val.price} ETH</span>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="d-flex justify-content-center mb-30">
                  <Link to="marketplace" className="btn btn-md
                                        btn-dark"> View all </Link>
                </div>
              </div>
            </div>
          </div>
