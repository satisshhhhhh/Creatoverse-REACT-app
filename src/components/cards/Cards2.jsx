            ...
            <div className="col-lg-8">
              <div className="section__head">
                ...
                <div className="d-flex">
                  <span className="color_text txt_sm d-none d-sm-block mr-10" style={{ minWidth: 'max-content' }}> FILTER BY: </span>
                  <ul className="menu_categories space-x-20">
                    <li className="d-flex space-x-10 switch_item">
                      <input type="checkbox" id="switch1" defaultChecked /><label htmlFor="switch1" className="ml-0">Toggle</label>
                      <span> Has list price </span>
                    </li>
                    <li className="d-flex space-x-10 switch_item">
                      <input type="checkbox" id="switch2" /><label htmlFor="switch2" className="ml-0">Toggle</label>
                      <span> Has open offer </span>
                    </li>
                    <li className="d-flex space-x-10 switch_item">
                      <input type="checkbox" id="switch3" /><label htmlFor="switch3" className="ml-0">Toggle</label>
                      <span> Has sold </span>
                    </li>
                  </ul>
                </div>
                      ...
                      <div className="card_body space-y-10">
                        ...
                        <div className="creators space-x-10">
                          <div className="avatars space-x-10">
                            <Link to="profile">
                              <img src={`img/avatars/avatar_${val.avatar_img}.png`} alt="Avatar" className="avatar avatar-md" />
                            </Link>
                            <div>
                              <p className="avatars_desc color_black">
                                <Link to="profile">
                                  <span className="txt _bold">@{val.avatar_name}</span>
                                </Link>
                                accepted an offer for about
                                <span className="color_brand">${val.price}</span>
                                on Bound To
                                Fall In Love from <span className="bayer">@{val.bayer}</span></p>
                              <span className="time color_text">{val.time}
                                min ago</span>
                            </div>
                          </div>
                        </div>
                        <div className="card_head">
                          <Link to="item-details">
                            <img src={`img/items/item_${val.img}.png`} alt="NFT" />
                          </Link>
                        </div>
                      </div>
                    </div>
