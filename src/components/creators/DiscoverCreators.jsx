            ...
            <div className="container">
                ...
                <div className="section_head">
                    ...
                    <div className="col-lg-4">
                        ...
                        <input type="text" placeholder="Search" className="bg_white" />
                    ...
                    <div className="col-lg-auto">
                    <select  className="select_custom btn btn-primary btn-sm">
                ...
                <div className="section__body space-y-20">
                    ...
                    <div className="col-lg-4" key={i}>
                        ...
                        <div className="avatars flex-column space-y-10">
                            <div className="cover">
                            <img src={`img/items/cover_${val.cover}.png`} alt="Avatar" className="img-fluid" />
                            </div>
                            <div className="media">
                            <Link to="profile">
                                <img src={`img/avatars/avatar_${val.img}.png`} alt="Avatar" className="avatar avatar-md" />
                            </Link>
                            </div>
                            <div className="details text-center">
                            <div>
                                <p className="color_black txt_lg">{val.Sold}
                                <span className="txt_sm">ETH</span></p>
                                <p className="color_black txt_sm">Sold</p>
                            </div>
                            <div>
                                <p className="color_black txt_lg">{val.Collections}</p>
