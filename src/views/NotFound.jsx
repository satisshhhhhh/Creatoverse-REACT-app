                ...
                <div className="container">
                    <div className="row justify-content-center align-items-center pt-100">
                        <div className="col-lg-3 d-none d-lg-block">
                            <img className="img-fluid" src={`img/bg/left-Skull.png`} alt="skull" />
                        </div>
                        ...
                        justify-content-center align-items-center">
                                    ...
                                    <div><Link to="/" className="btn btn-grad">Go Back</Link></div>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-3 d-none d-lg-block">
                            <img className="img-fluid" src={`img/bg/right-Skull.png`} alt="skull" />
                        </div>
                    </div>
                </div>
            </div>
