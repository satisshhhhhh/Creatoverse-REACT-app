                            ...
                            <Tabs className="forum__content">
                                <TabList className="d-flex space-x-10 mb-30 nav-tabs">
                                    <Tab className="nav-item">
                                        <Link className="btn btn-white btn-sm" data-toggle="tab" to="#tabs-1" role="tab">
                                                    ...
                                                    <div className="d-flex">
                                                        ...
                                                        <div className="space-y-20">
                                                            <Link to="post-details">
                                                                <h3 className="forum__title">Localbitcoins
                                                                    Clone Script | Localbitcoins
                                                                    Clone Software</h3>
                                                            </Link>
                                                            <p className="forum__desc">Hey guys! New
