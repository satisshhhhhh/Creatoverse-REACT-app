                    ...
                    <div className="row sm:space-y-30">
                            ...
                            <div className="forum__content space-y-30">
                                        ...
                                        <div className="d-flex align-items-center space-x-15">
                                            <div className="avatars space-x-10">
                                                <div className="media has_border">
                                                    <Link to="profile">
                                                        <img src="img/avatars/avatar_1.png" alt="Avatar" className="avatar avatar-forum" />
                                                    </Link>
                                                </div>
                                            ...
                                            <div className="category">
                                                <p className="color_black"><span className="color_text">in:</span>
                                                    General
                                                </p>
                                            </div>
                                        </div>
                                            ...
                                            <div className="avatars space-x-3">
                                                <div className="-space-x-20">
                                                    <Link className="d-none d-sm-inline" to="profile">
                                                        <img src="img/avatars/avatar_1.png" alt="Avatar" className="avatar avatar-sm" />
                                                    </Link>
                                                    <Link className="d-none d-sm-inline" to="profile">
                                                        <img src="img/avatars/avatar_2.png" alt="Avatar" className="avatar avatar-sm" />
                                                    </Link>
                                                    <Link className="d-none d-sm-inline" to="profile">
                                                        <img src="img/avatars/avatar_4.png" alt="Avatar" className="avatar avatar-sm" />
                                                    </Link>
                                                    <Link to="profile">
                                                        <img src="img/avatars/avatar_5.png" alt="Avatar" className="avatar avatar-sm" />
                                                    </Link>
                                                    <Link to="profile">
                                                        <img src="img/avatars/avatar_6.png" alt="Avatar" className="avatar avatar-sm" />
                                                    </Link>
                                    ...
                                    <div className="d-flex">
                                        ...
                                        <div className="space-y-20">
                                            <h3>Localbitcoins Clone
                                                ...
                                                Clone Software</h3>
                                            <p className="forum__desc">Hey guys! New exploration
                                        ...
                                        flex-wrap">
                                                ...
                                                <div className="answer">
                                                    <Link to="#" className="btn btn-dark btn-sm">Answer</Link>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="box comments__box">
                                    <div className="avatars">
                                        <div className="media has_border">
                                            <Link to="profile">
                                                <img src="img/avatars/avatar_3.png" alt="Avatar" className="avatar avatar-forum" />
                                            </Link>
                                        </div>
                                    </div>
                                    ...
                                    <div className="answer">
                                        <Link to="#" className="btn btn-primary btn-sm">Answer</Link>
                                    </div>
                                </div>
                                ...
                                <div className="box answers__box is__big space-y-20">
                                    <div>
                                        <div className="d-flex align-items-center space-x-15">
                                            <div className="avatars space-x-10">
                                                <div className="media has_border">
                                                    <Link to="profile">
                                                        <img src={`img/avatars/avatar_2.png`} alt="Avatar" className="avatar avatar-forum" />
                                                    </Link>
                                                </div>
                                                <div className="text-center">
                                                    <Link to="profile">
                                        ...
                                        <div className="d-flex">
                                            <div className="v__line">
                                            </div>
                                            <div className="space-y-20">
                                                <p className="forum__desc">I’m willing to send
                                                ...
                                                <div className="reaction space-x-15">
                                                    <span className="like space-x-5">
                                                        <Link to="#" className="like__btn"><i className="ri-thumb-up-line" /></Link>
                                                        <span>27 Like</span>
                                                    </span>
                                    ...
                                    <div>
                                        ...
                                        <div className="d-flex">
                                            ...
                                            <div className="space-y-20">
                                                <p className="forum__desc">Check regularly the
                                    ...
                                    <div>
                                        <div className="d-flex align-items-center space-x-15">
                                            <div className="avatars space-x-10">
                                                <div className="media has_border">
                                                    <Link to="profile">
                                                        <img src={`img/avatars/avatar_4.png`} alt="Avatar" className="avatar avatar-forum" />
                                                    </Link>
                                                </div>
                                                <div className="text-center">
                                                    <Link to="profile">
                                        ...
                                        <div className="d-flex">
                                            ...
                                            <div className="space-y-20">
                                                <p className="forum__desc">The best way to start
                                    ...
                                    <div>
                                        <div className="d-flex align-items-center space-x-15">
                                            <div className="avatars space-x-10">
                                                <div className="media has_border">
                                                    <Link to="profile">
                                                        <img src={`img/avatars/avatar_5.png`} alt="Avatar" className="avatar avatar-forum" />
                                                    </Link>
                                                </div>
                                                <div className="text-center">
                                                    <Link to="profile">
                                        ...
                                        <div className="d-flex">
                                            <div className="v__line last">
                                            </div>
                                            <div className="space-y-20">
                                                <p className="forum__desc">Hi! To my part I was
                        ...
                        <div className="col-lg-4">
                            <div className="sidebar space-y-30">
                                <Link to="#" className="btn btn-grad w-100">
                                            ...
                                            justify-content-between">
                                                        <div className="creators">
                                                            <div className="avatars space-x-3">
                                                                <div className="-space-x-20">
                                                                    <Link to="profil">
                                                                        <img src={`img/avatars/avatar_${val.avatar_img1}.png`} alt="Avatar" className="avatar avatar-sm" />
                                                                    </Link>
                                                                    <Link to="profil">
                                                                        <img src={`img/avatars/avatar_${val.avatar_img2}.png`} alt="Avatar" className="avatar avatar-sm" />
                                                                    </Link>
                                                                </div>
                                                                <Link to="profil">
                                                        ...
                                                        <Link to="#" className="space-x-3">
                                                            <p className="color_green txt_sm">{val.price}
                                                                ETH</p>
                                                        </Link>
                                                    </div>
                                                </div>
