                        ...
                        <div className="row">
                            <div className="col-lg-6">
                                <div className="box text-center">
                                    <img className="icon mb-20" src="img/icons/single.svg" alt="ImgPreview" />
                                    <div className="space-y-10">
                                        <h5>Sell One Time</h5>
                                        <p className="color_text">your collectible want to be one of a kind</p>
                                        <div className="hr" />
                                        <Link className="btn btn-grad btn" to="upload"> create single </Link>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-6">
                                <div className="box text-center">
                                    <img className="icon mb-20" src="img/icons/multiple.svg" alt="ImgPreview" />
                                    <div className="space-y-10">
