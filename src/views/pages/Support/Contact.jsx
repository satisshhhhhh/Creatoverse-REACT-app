                        ...
                        <div className="container">
                            <div className="content__wrap space-y-20">
                                <div className="space-y-20">
                                    ...
                                    <p className="contact__desc">We’re here to help and answer
                                        ...
                                        <div className="row">
                                            <div className="col-sm-6 space-y-20">
                                                <div className="space-y-10">
                                                    ...
                                                    <input type="email" className="form-control" placeholder="contact@Creabik.com" />
                                                </div>
                                                <div className="space-y-10">
                                            ...
                                            <div className="col-sm-6 space-y-20 mt-10">
                                                <div className="space-y-10">
                                                    ...
                                                    <input type="text" className="form-control" placeholder="Creabik" />
                                                </div>
                                                <div className="space-y-10">
                                            ...
                                            <div className="col-12 mt-20">
                                                <div className="space-y-10">
                                                    ...
                                                    <textarea style={{ minHeight: 110 }} className="mb-0" defaultValue={"                                        "} />
                                                </div>
                                            </div>
                                        </div>
                                        <Link to="#" className="btn btn-primary"> Send your  message  </Link>
